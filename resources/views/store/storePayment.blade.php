...
<body>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/StorePayment.css') }}">
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-5 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                ...
                <div class="mb-3 text-center">
                    <h3 class="text-white">Pawfect Store Checkout</h3>
                    <hr class="m-auto w-100" style="height: 3px; color: #EFF1FD;">
                </div>
                <!-- header -->

                <div class="featured-image mb-3">
                    <img src="images/xdd.png" class="img-fluid" style="height: 350px;">
                </div>
            </div>
            <!-- end of left box -->
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="input-group mt-4">
                            ...
                            <a href="../Login things/Login.html" class="btn btn-lg w-100 fs-6 text-white"
                                style="background-color: #4A9833;">Confirm Your Order</a>
                        </div>
                    </div>
                </form>
            </div>
