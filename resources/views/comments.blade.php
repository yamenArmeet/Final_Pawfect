...
<body>
    ...
    <!-- Comments -->
    <section class="Shelters my-5 p-lg-0 pt-lg-5" id="Shelters">
        <div class="container">
            <div class="row justify-content-center align-items-center d-flex">

                <!-- header -->
                <div class="mb-3 text-center">
                    <h1 class="text-dark">Welcome to Our Comment</h1>
                    <hr class="w-50 m-auto" style="height: 3px; color: #4D9B36;">
                </div>
                <!-- header -->

                <!-- Member 1 -->
                <div class="col-lg-4 col-md-6 col-12 p-0 my-3">
                    <div class="container my-2">
                        <div class="comment-card w-100">
                            ...
                            <p class="mb-0">
                                I've been using this service for months and I'm really satisfied with the performance
                                and support.
                            </p>
